...
<div class="max-w-3xl mx-auto px-4 py-10">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="bg-orange-600 p-6 text-center text-white">
            ...
            <p class="text-orange-100 text-sm mt-1">Selesaikan pesanan Anda sekarang</p>
        </div>
        ...
        <div class="p-8">
            <form action="{{ route('dropshipper.payment.process') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-8 text-center border-b border-gray-100 pb-8">
                    <p class="text-gray-500 mb-2 text-sm uppercase tracking-wide">Total Tagihan</p>
                    <div class="text-4xl font-bold text-gray-900">Rp {{ number_format($totalHarga, 0, ',', '.') }}</div>
                </div>

                <div class="mb-6">
                    <label class="block text-sm font-bold text-gray-800 mb-3">Pilih Metode Pembayaran</label>
                    <select name="payment_method" id="paymentMethod" onchange="changeRekening()" class="w-full border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-orange-500 outline-none transition">
                ...
                <div class="mb-8">
                    <label class="block text-sm font-bold text-gray-800 mb-3">Upload Bukti Bayar (Screenshot)</label>
                    <div class="relative">
                        <input type="file" name="proof_of_payment" id="fileUpload" class="hidden" onchange="previewFile()">
                        <label for="fileUpload" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:bg-orange-50 hover:border-orange-400 transition bg-gray-50">
                            <div class="text-center" id="uploadPlaceholder">
                                ...
                                <p class="text-sm text-gray-600"><span class="font-bold text-orange-600">Klik Upload</span> atau bukti apapun</p>
                                <p class="text-xs text-gray-400 mt-1">Simulasi: Gambar apapun akan diterima</p>
                            </div>
